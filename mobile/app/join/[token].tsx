...
import { UsersThree, CaretLeft, WarningCircle, ArrowSquareOut } from "phosphor-react-native";
...
export default function JoinGroupScreen() {
  ...
  const handleOpenExternal = () => {
    ...
    // intent:// scheme 讓 Android 嘗試用 Chrome 開啟；iOS 直接用 Linking
    Linking.openURL(url).catch(() => {
      // fallback: 提示使用者手動複製網址
